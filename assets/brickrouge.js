...
var a=c.getParent("form");if(a){a.getElements(".error").removeClass("error");}c.getParent("div.alert-message").destroy();
});BrickRouge.Popover=new Class({Implements:[Events,Options],options:{anchor:null,placement:null,visible:false},initialize:function(b,a){this.element=$(b);
...
}this.element.addEvent("click",this.onClick.bind(this));if(this.options.visible){this.show();
}},attachAnchor:function(a){this.anchor=$(a);if(!this.anchor){this.anchor=$(document.body).getElement(a);

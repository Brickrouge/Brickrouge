...
define([
...
], function (Brickrouge, Viewport, Subject) {
	 ...
	 */
	let ActionEvent = Subject.createEvent('action', function (action, popover, originalEvent) {
	...
	let Popover = new Class({
		...
		changePlacement: function (placement)
		{
			...
			Object.forEach(placementClasses, function (className) {
	...
	{
		Object.forEach(popovers, function (popover) {
	...
	Brickrouge.observe(Brickrouge.EVENT_RUNNING, function () {

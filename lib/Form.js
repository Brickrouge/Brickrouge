...
define([
	...
	var Form = new Class({
		...
		clearAlert: function()
		{
			...
			Array.prototype.forEach.call(el.querySelectorAll('.alert.dismissible'), function (alert) {

				alert.remove()

			})

			Array.prototype.forEach.call(el.querySelectorAll('.has-danger'), function (control) {

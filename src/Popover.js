...
(Brickrouge, Viewport, Subject) => {
	 ...
	 */
	class Popover extends Brickrouge.mixin(Object, Subject) {
		...
		static from(options)
		{
			...
			const popover = new Element('div.popover').adopt([new Element('div.popover-arrow'), inner])
		...
		attachAnchor(anchor)
		{
			if (typeof anchor === 'string')
			{
				...
				if (!element)
				{
					element = document.body.querySelector(anchor)
				}
			...
			{
				throw new Error("Anchor must be an element or a selector. Given:", anchor)
			}
